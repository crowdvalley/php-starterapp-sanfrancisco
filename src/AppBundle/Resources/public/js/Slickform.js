	 ...
	 */
	 $('#slickform').submit(
		function slickcontactparse() {
			...
			// Values
			var successmessage = "Thank you for your message, we will be in contact soon!";
			...
			if (usersemail.val() == "") {
				$(".slickbutton").animate({marginTop:'100px'},1000).delay(6000).animate({marginTop:'0px'},1000);
